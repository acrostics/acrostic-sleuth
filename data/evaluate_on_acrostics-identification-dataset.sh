...
java -jar AcrosticSleuth.jar -input data/acrostic-identification-dataset/en -language EN -mode LINE -charset utf-8 -outputSize 200000 --wikisource -workers 10 > output/en.tsv
java -jar AcrosticSleuth.jar -input data/acrostic-identification-dataset/ru -language RU -mode LINE -charset utf-8 -outputSize 200000 --wikisource -workers 10 > output/ru.tsv
java -jar AcrosticSleuth.jar -input data/acrostic-identification-dataset/fr -language FR -mode LINE -charset utf-8 -outputSize 200000 --wikisource -workers 10 > output/fr.tsv
